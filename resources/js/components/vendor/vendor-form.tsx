                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="e.g. FastNet 100 Mbps Plan"
                                    />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        placeholder="e.g. /storage/logos/logo.png"
                                    />
                                </div>
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        onChange={handleChange}
                                        placeholder="e.g. Affordable fiber plan with no FUP."
                                    />
                                </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        placeholder="e.g. Unlimited Data, Free Router, 24/7 Support"
                                    />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        value={formData.faqs}
                                        onChange={handleChange}
                                        placeholder='e.g. [{"question": "Is it unlimited?", "answer": "Yes, truly unlimited."}]'
                                    />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        onChange={handleChange}
                                        placeholder="e.g. /images/1.jpg, /images/2.jpg"
                                    />
                                </div>
                            </div>
